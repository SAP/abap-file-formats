INTERFACE zif_aff_smbc_v1
  PUBLIC.
  CONSTANTS:
    "! <p class="shorttext synchronized">Skip Root Mode</p>
    BEGIN OF co_skip_root_mode,
      "! <p class="shorttext synchronized">Skip root entity list report</p>
      skip                     TYPE c LENGTH 1 VALUE 'X',
      "! <p class="shorttext synchronized">Do not skip root entity list report</p>
      do_not_skip              TYPE c LENGTH 1 VALUE '',
      "! <p class="shorttext synchronized">Skip root entity list report without calculation</p>
      "! Improved runtime compared to {@link zif_aff_smbc_v1.data:co_skip_root_mode.skip}
      skip_without_calculation TYPE c LENGTH 1 VALUE 'P',
    END OF co_skip_root_mode,
  ...
  TYPES:
    ...
    "! <p class="shorttext synchronized">Skip Root Mode</p>
    "! $values {@link zif_aff_smbc_v1.data:co_skip_root_mode}
    "! $default {@link zif_aff_smbc_v1.data:co_skip_root_mode.do_not_skip}
    ty_skip_root_entity TYPE c LENGTH 1,
  ...
  TYPES:
    ...
    BEGIN OF ty_service_configuration,
      ...
      "! <p class="shorttext">Skip Root Mode</p>
      "! Automatically navigate to the Object Page of the root entity
      "! $showAlways
      skip_root_entity    TYPE ty_skip_root_entity,
