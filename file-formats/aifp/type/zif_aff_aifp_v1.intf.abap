INTERFACE zif_aff_aifp_v1
  ...
  TYPES ty_check_scenario TYPE c LENGTH 10.
  CONSTANTS:
  ...
  TYPES ty_simple_field_check TYPE c LENGTH 1.
  CONSTANTS:
  ...
  TYPES ty_operator_db TYPE c LENGTH 2.
  CONSTANTS:
  ...
  TYPES ty_database_check_type TYPE c LENGTH 1.
  CONSTANTS:
  ...
  "! Single checks
  TYPES ty_single_checks TYPE STANDARD TABLE OF ty_single_check WITH DEFAULT KEY.
