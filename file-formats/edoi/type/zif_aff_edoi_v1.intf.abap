INTERFACE zif_aff_edoi_v1 PUBLIC.
  ...
  TYPES ty_edoc_interface_versions TYPE SORTED TABLE OF ty_edoc_interface_version WITH UNIQUE KEY interface_version.
  TYPES:
    ...
    BEGIN OF ty_edoc_int_drc_attr,
      ...
      "! $required
      response_interface_version TYPE c LENGTH 4,
